...
const permissionsData = [
  ...
  { id: 'teacher_view', module: 'People & Staff', action: 'view', code: 'teacher_view', name: 'View Teachers & Staff', description: 'View staff directory and member profiles' },
  { id: 'teacher_create', module: 'People & Staff', action: 'create', code: 'teacher_create', name: 'Create Teacher / Staff', description: 'Register new teachers and staff members' },
  { id: 'teacher_edit', module: 'People & Staff', action: 'edit', code: 'teacher_edit', name: 'Edit Teacher / Staff', description: 'Modify staff profile and details' },
  { id: 'teacher_delete', module: 'People & Staff', action: 'delete', code: 'teacher_delete', name: 'Delete Teacher / Staff', description: 'Remove staff member records' },
  ...
  { id: 'role_create', module: 'Roles & Access Control', action: 'create', code: 'role_create', name: 'Create Role', description: 'Create new custom system roles' },
  { id: 'role_edit', module: 'Roles & Access Control', action: 'edit', code: 'role_edit', name: 'Edit Role', description: 'Modify role metadata and assigned permissions' },
  { id: 'role_delete', module: 'Roles & Access Control', action: 'delete', code: 'role_delete', name: 'Delete Role', description: 'Delete custom system roles' },
  { id: 'role_activate', module: 'Roles & Access Control', action: 'activate', code: 'role_activate', name: 'Activate/Deactivate Role', description: 'Toggle role active/inactive status' },
  ...
  { id: 'school_edit', module: 'School Setup', action: 'edit', code: 'school_edit', name: 'Edit School Profile', description: 'Update school profile and configuration' },
  { id: 'campus_view', module: 'School Setup', action: 'view', code: 'campus_view', name: 'View Campuses', description: 'View school campus list' },
  { id: 'campus_create', module: 'School Setup', action: 'create', code: 'campus_create', name: 'Create Campus', description: 'Register new school campus' },
  { id: 'campus_edit', module: 'School Setup', action: 'edit', code: 'campus_edit', name: 'Edit Campus', description: 'Modify campus details' },
  { id: 'campus_delete', module: 'School Setup', action: 'delete', code: 'campus_delete', name: 'Delete Campus', description: 'Remove school campus' },
  ...
  try {
    ...
    for (const r of defaultRoles) {
      ...
      const rolePerms = isSuper
        ...
        : r.code === 'TEACHER'
        ? ['teacher_view', 'grade_view', 'section_view', 'subject_view', 'class_subject_view']
        : ['teacher_view', 'school_view', 'campus_view', 'grade_view', 'section_view'];
